...
train_ds = processed_ds.train_test_split(test_size=0.01, seed=42)["train"]
val_ds = processed_ds.train_test_split(test_size=0.01, seed=42)["test"]

# Save as train.parquet and validation.parquet
train_ds.to_parquet("train.parquet")
val_ds.to_parquet("validation.parquet")
val_ds.to_json("validation.jsonl", orient="records", lines=True)